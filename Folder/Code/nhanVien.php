...
<body>
            ...
            <nav class="col-md-2 d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item list-group-item-action active">Nhân Viên</a>
    ...
    <div id="them-nhan-vien">
        <div class="card">
            <div class="card-header bg-primary text-white" style="text-align: center;">Thông tin nhân viên</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9">
                        <div class="border p-2 mb-2 d-flex align-items-center">
                            <strong class="me-3 flex-shrink-0">Mã Nhân Viên:</strong>
                            <div class="flex-grow-1">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="border p-2 mb-2 d-flex align-items-center">
                            <strong class="me-3 flex-shrink-0">Tên nhân viên:</strong>
                            <div class="flex-grow-1">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="border p-2 mb-2 d-flex align-items-center">
                            <strong class="me-3 flex-shrink-0">Vị trí:</strong>
                            <div class="flex-grow-1">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="border p-2 mb-2 d-flex align-items-center">
                            <strong class="me-3 flex-shrink-0">Email:</strong>
                            <div class="flex-grow-1">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="border p-2 mb-2 d-flex align-items-center" style="width: 100%; height: 100%;">
                            <strong class="me-3 flex-shrink-0">Ảnh:</strong>
                    ...
                    <div class="col-md-6">
                        <div class="border p-2 mb-2 d-flex align-items-center">
                            <strong class="me-3 flex-shrink-0">Ngày vào làm:</strong>
                            <div class="flex-grow-1">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="border p-2 mb-2 d-flex align-items-center">
                            <strong class="me-3 flex-shrink-0">Dân tộc:</strong>
                            <div class="flex-grow-1">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="border p-2 mb-2 d-flex align-items-center">
                            <strong class="me-3 flex-shrink-0">Ngày sinh:</strong>
                            <div class="flex-grow-1">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="border p-2 mb-2 d-flex align-items-center">
                            <strong class="me-3 flex-shrink-0">Giới tính:</strong>
                            <div class="flex-grow-1">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-end">
                        ...
                        <div class="edit-button">
                            ...
                            <button class="btn btn-primary"><i class=""></i> Thêm nhân viên</button>
                        </div>
                    </div>
                </div>
            </div>
